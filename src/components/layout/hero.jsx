          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <motion.p
                ...
                transition={{ duration: 0.8 }}
              >
                a passionate frontend developer with a keen eye for detail and a
                love for creating beautiful, user-friendly web applications. My
                journey in web development has been driven by a desire to craft
                seamless user experiences and bring ideas to life through code.
              </motion.p>
            </div>

            {/* EXPERİENCE AND YEAR PART */}
